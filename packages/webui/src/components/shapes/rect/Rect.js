...
const Rect = ({id, x, y, label, height, width, color, filter, onMoveShape, moveConnector, dropConnector, onResize, currentDropTarget, onSelect, isSelected, isConnecting, isConnectingMe, connecting}) =>
  <g>
